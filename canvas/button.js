JUI.canvas.button = class extends JRENDER.canvas.renderObject{
    constructor(canvas, color, x, y, w, h, r, alignHorizontal = "left", alignVertical = "top", border = false, border_width = 1, border_color = "#000000"){
    ...
    setClickEvent(_calback){
        this.clickId = JLIB.api.addClickEvent(this.getBox(), _calback);
    }
